...
private:
    ...
    // void onStaticInfoSse(StaticInfoSse* p);

    // void onOptionSseL1(OptionSseL1* msgdata);

    // void onFundSseL1(FundSseL1* msgdata);
...
class XeleReceiver : public XeleMdSseSpi
{
public:
    XeleReceiver(){};
    ~XeleReceiver(){};
    ...
    void Init(cffex::fb::api::fb_i_md_spi *fb_spi, fb_market_data_t *fb_md, InstMap<QuotaInfo> *quota_cache);
