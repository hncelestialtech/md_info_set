...
/// 货币基金申购
#define HS_OD_CBPOF_OFC      45
/// 货币基金赎回
#define HS_OD_CBPOF_OFR      46
/// REITs基金认购
#define HS_OD_ReitsFundSubs  47
/// 场内基金认购
#define HS_OD_OFundSubs      48
/// 借券卖出
#define HS_OD_BorrowSell     49
...
/// HSBillContent：账单内容 
//////////////////////////////////////////////////////////////////////////
typedef char HSBillContent[2000];
...
//////////////////////////////////////////////////////////////////////////
/// HSMacAddressInfo：Mac地址信息
//////////////////////////////////////////////////////////////////////////
typedef char HSMacAddressInfo[128];
...
/// 大宗交易定价委托
#define HS_CT_BlockPricing                          28
/// 大宗交易确认委托
#define HS_CT_BlockConfirm                          29
/// 大宗交易互报确认委托
#define HS_CT_BlockMutualConfirm                    30
/// 大宗交易盘后收盘价委托
#define HS_CT_BlockAFC                              31
/// 大宗交易盘后加权平均价委托
#define HS_CT_BlockAFW                              32
/// 大宗交易意向委托
#define HS_CT_BlockIntention                        33
/// 北证及股转限价
#define HS_CT_BJSGZLimit							34
/// 限价小节有效
#define HS_CT_LimitGIS                              35
/// 限价止损小节有效
#define HS_CT_LimitStopLossGIS                      36
/// 限价止盈小节有效
#define HS_CT_LimitStopProfitGIS                    37
/// 市价小节有效
#define HS_CT_MarketGIS                             38
/// 市价止损小节有效
#define HS_CT_MarketStopLossGIS                     39
/// 市价止盈小节有效
#define HS_CT_MarketStopProfitGIS                   40
...
#define HS_UAT_PB        			'#'
/// 网下现金
#define HS_UAT_OfflineCash        	'+'
/// 网下证券
#define HS_UAT_OfflineStock        	'-'
/// 自助委托
#define HS_UAT_SelfService        	'0'
/// 电话委托
#define HS_UAT_Phone        		'1'
/// 驻留委托
#define HS_UAT_Resident         	'2'
/// 远程委托
#define HS_UAT_Remote         		'3'
/// 柜台委托
#define HS_UAT_Counter         		'4'
/// 漫游委托
#define HS_UAT_Roaming       		'5'
/// 分支委托
#define HS_UAT_Branch   			'6'
/// 网上委托
#define HS_SET_Online         		'7'
/// 手机委托
#define HS_UAT_Mobile   			'8'
/// 网页委托
#define HS_UAT_Web        			'9'
/// 投顾柜面
#define HS_UAT_IACounter  			'@'
/// 自定义委托E
#define HS_UAT_CustomE      		'E'
/// 银行680
#define HS_UAT_Bank680        		'J'
/// 银行托银
#define HS_UAT_BankCustody        	'K'
/// 银行委托
#define HS_UAT_Bank         		'L'
/// 自定义委托M
#define HS_UAT_CustomM       		'M'
/// 中台临柜接入
#define HS_UAT_MidOfficeCounter    	'N'
/// 离柜委托
#define HS_UAT_OffCounter        	'O'
/// 自定义委托S
#define HS_UAT_CustomS   			'S'
/// 要约收购
#define HS_UAT_TenderOffer         	'U'
/// 招商柜面
#define HS_UAT_CMBCounter   		'X'
/// 证券托银
#define HS_UAT_SecuCustody   		'Y'
/// VIP委托
#define HS_UAT_VIP   				'Z'
/// 自定义委托_
#define HS_UAT_Custom_				'_'
/// 代客理财
#define HS_UAT_Manage				'a'
/// 代理委托
#define HS_UAT_Agency 				'b'
/// 短信委托
#define HS_UAT_Message				'd'
/// GPRS委托
#define HS_UAT_GPRS					'g'
/// VTM委托
#define HS_UAT_VTM					'j'
/// 自定义委托k
#define HS_UAT_Customk				'k'
/// Fix终端
#define HS_UAT_Fix					'm'
/// 自定义委托o
#define HS_UAT_Customo				'o'
/// 银行POS
#define HS_UAT_POS					'p'
/// 自定义委托q
#define HS_UAT_Customq				'q'
/// BREW委托
#define HS_UAT_BREW					'r'
/// ETF算法交易
#define HS_UAT_ETFAlgoTrade			's'
/// 融资外围
#define HS_UAT_MFPeripheral 		't'
/// 银行柜台
#define HS_UAT_BankCounter			'u'
/// 第三方柜台
#define HS_UAT_3PtyCounter			'v'
/// 集中柜面
#define HS_UAT_CentralCounter 		'z'
/// 自定义委托{
#define HS_UAT_CustomLCBracket 		'{'
/// 自定义委托}
#define HS_UAT_CustomRCBracket		'}'
/// 大宗交易
#define HS_UAT_BlockTrade			'~'
...
/// 增发申购
#define HS_ST_AddApply	  "7"
/// 特殊业务
#define HS_ST_SpecBusi	  "8"
/// 记账国债
#define HS_ST_RegDebt     "9"
/// 基金申赎
#define HS_ST_FundAppRed  "A"
/// 基金设红
#define HS_ST_FundBonus   "B"
/// 跨市转托
#define HS_ST_SpanTrust   "C"
/// 交易权证
#define HS_ST_EntRight    "D"
/// 行权权证
#define HS_ST_RightDo     "F"
/// 国债申购
#define HS_ST_DebtApply    "G"
/// 国债分销
#define HS_ST_DebtSale    "I"
/// 基金申购
#define HS_ST_FundApply   "J"
/// 基金认购
#define HS_ST_FundSub     "K"
/// LOF基金
#define HS_ST_LofFund     "L"
/// ETF认购
#define HS_ST_EtfSubs     "M"
/// ETF申赎
#define HS_ST_EtfAppRed   "N"
/// 基金转换
#define HS_ST_FundTrans   "O"
/// 配售申购
#define HS_ST_MatchApply  "P"
/// 企债回购
#define HS_ST_CorpDebtBack "Q"
/// 指定交易
#define HS_ST_RegTrade    "R"
/// ETF基金
#define HS_ST_EtfFund     "T"
/// 企业债券
#define HS_ST_CorpDebt    "U"
/// ETF资金
#define HS_ST_EtfCapital  "V"
/// 凭证国债
#define HS_ST_VoucherDebt "X"
/// 企业转债
#define HS_ST_CorpTransDebt "Y"
/// 国债回购
#define HS_ST_DebtBack    "Z"
/// 创业板
#define HS_ST_Gem         "c"
/// 存托凭证
#define HS_ST_Cdr         "d"
...
#define HS_ST_Star        "e"
/// 质押代码
#define HS_ST_ImpCode     "f"
/// 科创板存托凭证
#define HS_ST_StarCdr     "g"
/// 货币ETF申赎
#define HS_ST_MonEtfSub   "i"
/// 货币ETF基金
#define HS_ST_MonEtfFund  "j"
/// 国债ETF申赎
#define HS_ST_DebtEtfApply "k"
/// 国债ETF基金
#define HS_ST_DebtEtfFund "l"
/// 注册制创业板
#define HS_ST_RegGem      "p"
/// 注册制创业板存托凭证
#define HS_ST_RegGemCdr   "q"
/// 基础设施基金
#define HS_ST_Reits       "r"
/// 公司债
#define HS_ST_CompanyDebt "u"
/// 国债预发行
#define HS_ST_WhenIssue   "w"
/// 报价股份
#define HS_ST_QuotedShares "z"
...
/// 货币基金
#define HS_SST_IMFFund					"A1"
/// 非公开优先股转让(股转)
#define HS_SST_NonPublicPreferStockTrans "z2"
/// 北交所股票
#define HS_SST_BSEStock		   			"z3"
/// 北交所优先股
#define HS_SST_BSEPreferStock		    "z4"
...
//////////////////////////////////////////////////////////////////////////
/// 普通资产
#define HS_AP_NORMAL	'0'
/// 信用资产
#define HS_AP_CREDIT	'7'
...
#define HS_NOTICE_NO_RISK_OVER_LIMIT 5
typedef int32 HSNoticeNo;
...
//////////////////////////////////////////////////////////////////////////
/// 行权前期权对冲
#define HS_SCT_BeforeExe         '0'
/// 履约后期货对冲
#define HS_SCT_AfterExe          '1'
/// 保留期权仓位
#define HS_SCT_KeepPos           '2'
...
//////////////////////////////////////////////////////////////////////////
/// 对冲设置
#define HS_SSC_SelfClose         '0'
/// 对冲设置取消
#define HS_SSC_Cancel            '1'
...
/// HSErrorLog:错误信息
////////////////////////////////////////////////////////////////////////// 
typedef char HSErrorLog[6000];

//////////////////////////////////////////////////////////////////////////
/// HSRelationName:联系人姓名
//////////////////////////////////////////////////////////////////////////
typedef char HSRelationName[121];

//////////////////////////////////////////////////////////////////////////
/// HSRelationTel:联系人电话
//////////////////////////////////////////////////////////////////////////
typedef char HSRelationTel[33];

//////////////////////////////////////////////////////////////////////////
/// HSPropSeatNo:对方席位号
//////////////////////////////////////////////////////////////////////////
typedef char HSPropSeatNo[9];

//////////////////////////////////////////////////////////////////////////
/// HSConferId:约定号
//////////////////////////////////////////////////////////////////////////
typedef char HSConferId[11];

//////////////////////////////////////////////////////////////////////////
/// HSNationality:国籍地区
//////////////////////////////////////////////////////////////////////////
typedef char HSNationality[4];

//////////////////////////////////////////////////////////////////////////
/// HSAddress:地址
//////////////////////////////////////////////////////////////////////////
typedef char HSAddress[121];

//////////////////////////////////////////////////////////////////////////
/// HSName:姓名
//////////////////////////////////////////////////////////////////////////
typedef char HSName[65];

//////////////////////////////////////////////////////////////////////////
/// HSOrganName:机构名称
//////////////////////////////////////////////////////////////////////////
typedef char HSOrganName[61];

//////////////////////////////////////////////////////////////////////////
/// HSGroupName:组别名称
//////////////////////////////////////////////////////////////////////////
typedef char HSGroupName[13];

//////////////////////////////////////////////////////////////////////////
/// HSTelCode:联系电话
//////////////////////////////////////////////////////////////////////////
typedef char HSTelCode[21];

//////////////////////////////////////////////////////////////////////////
/// HSTriggerFlag:触警标志
//////////////////////////////////////////////////////////////////////////
//未触警
#define   HS_TF_NoRisk                       '0'  
//触警
#define   HS_TF_Alert                        '1' 
typedef char HSTriggerFlag;

//////////////////////////////////////////////////////////////////////////
/// HSRiskContent:触警信息
//////////////////////////////////////////////////////////////////////////
typedef char HSRiskContent[513];

//////////////////////////////////////////////////////////////////////////
/// HSArcsName:风控名称
//////////////////////////////////////////////////////////////////////////
typedef char HSArcsName[121];

//////////////////////////////////////////////////////////////////////////
/// HSClientName:客户名称
//////////////////////////////////////////////////////////////////////////
typedef char HSClientName[257];

//////////////////////////////////////////////////////////////////////////
/// HSBTradeconferId:约定号
//////////////////////////////////////////////////////////////////////////
typedef char HSBTradeconferId[11];

//////////////////////////////////////////////////////////////////////////
/// HSEtfComponentCode:成分股代码
//////////////////////////////////////////////////////////////////////////
typedef char HSEtfComponentCode[21];

//////////////////////////////////////////////////////////////////////////
/// HSLockStockQuoteID：锁券行情编号(收益互换借券业务)
//////////////////////////////////////////////////////////////////////////
typedef char HSLockStockQuoteID[33];

//////////////////////////////////////////////////////////////////////////
/// HSLockCompactStatus：锁券合约状态(收益互换借券业务)
//////////////////////////////////////////////////////////////////////////
/// 未生效
#define HS_LCS_InEffective		'0'
/// 正常
#define HS_LCS_Normal			'1'
/// 作废
#define HS_LCS_Void				'2'
/// 到期了结
#define HS_LCS_SettleOnTime		'3'
/// 到期未了结
#define HS_LCS_UnSettleExpired	'4'
/// 超期了结
#define HS_LCS_SettleLate		'5'
/// 提前了结
#define HS_LCS_SettleEarly		'6'
/// 锁券待分配
#define HS_LCS_ToAssign			'7'
/// 锁券已撤销
#define HS_LCS_Canceled			'8'
typedef char HSLockCompactStatus;

//////////////////////////////////////////////////////////////////////////
/// HSEarlyRecallMode：提前召回模式(收益互换借券业务)
//////////////////////////////////////////////////////////////////////////
/// 不召回
#define HS_ERM_NoRecall	'0'
/// T+0
#define HS_ERM_Today	'1'
/// T+1
#define HS_ERM_Morrow	'2'
typedef char HSEarlyRecallMode;
...
//////////////////////////////////////////////////////////////////////////
typedef char HSCombStrategyName[128];

//////////////////////////////////////////////////////////////////////////
/// HSOfferType：报盘类型
//////////////////////////////////////////////////////////////////////////
/// 上海竞价流模式报盘
#define HS_OT_Binary		1
/// 深圳集中竞价交易报盘
#define HS_OT_Auction		2
typedef int32 HSOfferType;
...
/// 是券商
#define HS_PSF_Yes		'1'
typedef char HSPdSecuFlag;

//////////////////////////////////////////////////////////////////////////
/// HSExtendField:扩展字段
//////////////////////////////////////////////////////////////////////////
typedef char HSExtendField[33];

//////////////////////////////////////////////////////////////////////////
/// HSLockStockMode：锁券模式
//////////////////////////////////////////////////////////////////////////
/// 实时券:锁券后，能够根据锁券保证金及券源数量立刻确认锁券结果的券
#define HS_LSM_Realtime		'1'
/// 非实时券:锁券后，能够根据锁券保证金及券源数量立刻确认锁券结果的券
#define HS_LSM_NoRealtime	'2'
typedef char HSLockStockMode;

//////////////////////////////////////////////////////////////////////////
/// HSLockStockApplyStatus：锁券申请状态
//////////////////////////////////////////////////////////////////////////
/// 已报
#define HS_LSAS_Reported		'0'
/// 全部成交
#define HS_LSAS_Traded			'1'
/// 部分成交
#define HS_LSAS_PartsTraded		'2'
/// 失败
#define HS_LSAS_Failed			'3'
/// 已撤
#define HS_LSAS_Canceled 		'4'
typedef char HSLockStockApplyStatus;


//////////////////////////////////////////////////////////////////////////
/// HSQuoteDataType：行情数据类别
//////////////////////////////////////////////////////////////////////////
/// 快照
#define HS_QDT_SNAP           0x01
/// 逐笔成交
#define HS_QDT_TRANS_Trade    0x02
/// 逐笔委托
#define HS_QDT_TRANS_Entrust    0x04
typedef uint32 HSQuoteDataType;

//////////////////////////////////////////////////////////////////////////
/// HSQuoteProductID：行情数据产品编号
//////////////////////////////////////////////////////////////////////////
typedef uint16   HSQuoteProductID;


//////////////////////////////////////////////////////////////////////////
/// HSSecuritiesSpecialMarker：证券属性标记
//////////////////////////////////////////////////////////////////////////
/// 注册制标识 沪深 
#define HS_SSM_REGISTRATION    0x01
/// 融资标识 沪深
#define HS_SSM_CRDBUY          0x02
/// 融券标识 沪深
#define HS_SSM_CRDSELL         0x04
/// 退市整理 沪深
#define HS_SSM_DELIST          0x08
/// 风险警示 沪深
#define HS_SSM_RISKWARN        0x10
/// 除权标识 沪深
#define HS_SSM_EXRIGHT         0x40
/// 除息标识 沪深
#define HS_SSM_EXDIVIDEND      0x80
typedef uint64 HSSecuritiesSpecialMarker;

//////////////////////////////////////////////////////////////////////////
/// HSStbTransType：转让类型
//////////////////////////////////////////////////////////////////////////
/// 集合竞价+连续竞价
#define HS_STT_AuctionAndContinuous	'B'
/// 集合竞价
#define HS_STT_Auction				'C'
/// 做市转让
#define HS_STT_MarketMaking			'M'
/// 其他类型
#define HS_STT_Other				'O'
/// 大宗交易
#define HS_STT_BlockTrading			'T'
/// 公开发行
#define HS_STT_PublicOffering		'P'
typedef char HSStbTransType;

//////////////////////////////////////////////////////////////////////////
/// HSStbTransStatus：转让状态
//////////////////////////////////////////////////////////////////////////
/// 正常状态
#define HS_STS_Normal            			'N'
/// 首日挂牌
#define HS_STS_FirstListing     			'Y'
/// 新增股票挂牌转让
#define HS_STS_NewStockListing  			'D'
/// 公开发行询价
#define HS_STS_PublicOfferingInquiry 		'I'
/// 公开发行申购
#define HS_STS_PublicOfferingSubscription 	'F'
typedef char HSStbTransStatus;
