...
class fb_crr_on_future_theoretical_algorithm : public i_theoretical_algorithm {
public:
    class input_params {
    public:
        input_params() {}
    ...
    public:
        ...
        full_params(unsigned option_type,
                    ...
                    double   speed,
                    double   zomma) :
            input_(option_type, F, K, T, r, sig, steps),
    ...
    fb_crr_on_future_theoretical_algorithm();
    virtual ~fb_crr_on_future_theoretical_algorithm();
