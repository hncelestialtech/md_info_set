...
class fb_black76_custom_demo_theoretical_algorithm : public i_theoretical_algorithm {
public:
	class input_params {
	public:
		input_params() {}
	...
	fb_black76_custom_demo_theoretical_algorithm();
	virtual ~fb_black76_custom_demo_theoretical_algorithm();
...
private:
	...
	int calc_uncommon_greeks(IN unsigned short option_type, IN double F, IN double K, IN double T, IN double r, IN double sig, OUT double* theta, OUT double* rho, OUT double* charm, OUT double* vonna, OUT double* vomma, OUT double* speed, OUT double* zomma);
private:
...
private:
	...
	std::vector<double> custom_greeks_;
};
