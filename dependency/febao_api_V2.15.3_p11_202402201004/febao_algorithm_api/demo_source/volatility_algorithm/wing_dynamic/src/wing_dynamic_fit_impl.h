#ifndef CFFEX_MM_WING_DYNAMIC_FIT_IMPL_H
#define CFFEX_MM_WING_DYNAMIC_FIT_IMPL_H
...
class wing_dynamic_fit_impl {
public:
	wing_dynamic_fit_impl();
	virtual ~wing_dynamic_fit_impl();
