...
#define CLASSNAME
#else
#include "fb_wing_static_custom_demo_linux_api.h"
#include "wing_fit_impl.h"
#define CLASSNAME fb_wing_static_custom_demo_algorithm::
static cffex::fb::plugin::wing_fit_impl g_wing_fit_impl;
#endif

#include "wing_custom_demo_model_impl.h"

static cffex::fb::plugin::wing_custom_demo_model_impl g_wing_model_impl;
