#ifndef CFFEX_MM_WING_MODEL_IMPL_H
#define CFFEX_MM_WING_MODEL_IMPL_H
...
class wing_custom_demo_model_impl {
public:
	wing_custom_demo_model_impl();
    virtual ~wing_custom_demo_model_impl();
...
private:
    ...
    double volatility_custom1_;
    double volatility_custom2_;
};
