#ifndef FB_SERIAL_PRICING_PARAM_CONFIG_STREAM_H
#define FB_SERIAL_PRICING_PARAM_CONFIG_STREAM_H
...
class serial_pricing_param_config_stream :
    public i_stream_with_id<serial_pricing_param_config_stream,
...
public:
    serial_pricing_param_config_stream(msg_callback  callback,
                                       snap_callback s_callback);
    serial_pricing_param_config_stream(msg_callback callback);
    serial_pricing_param_config_stream();
    ~serial_pricing_param_config_stream();
