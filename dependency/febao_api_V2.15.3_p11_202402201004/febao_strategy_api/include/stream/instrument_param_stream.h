...
#ifndef FB_INSTRUMENT_PARAM_STREAM_H
#define FB_INSTRUMENT_PARAM_STREAM_H
...
class instrument_param_stream :
    public i_stream_with_id<instrument_param_stream, STRATEGY_STREAM_INSTRUMENT_PARAM> {
public:
    ...
    public:
        ...
        virtual bool get_param(IN const char *instrument_id,
        ...
        virtual bool get_param(IN uint64_t    instrument_index,
                               IN const char *param_name,
                               OUT int       *param_value) const      = 0;
        virtual bool get_param(IN uint64_t    instrument_index,
                               IN const char *param_name,
...
public:
    instrument_param_stream(msg_callback callback, snap_callback s_callback);
    instrument_param_stream(msg_callback callback);
    instrument_param_stream();
    ~instrument_param_stream();
