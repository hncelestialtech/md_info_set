#ifndef FB_ATM_FORWARD_MD_STREAM_H
#define FB_ATM_FORWARD_MD_STREAM_H
...
class atm_forward_md_stream :
    public i_stream_with_id<atm_forward_md_stream,
...
public:
    ...
    public:
        ...
        virtual double      get_atm_forward_price() const   = 0;
...
public:
    atm_forward_md_stream(msg_callback callback, snap_callback s_callback);
    atm_forward_md_stream(msg_callback callback);
    atm_forward_md_stream();
    ~atm_forward_md_stream();
