#ifndef FB_POSITION_STREAM_H
#define FB_POSITION_STREAM_H
...
class position_stream :
    public i_stream_with_id<position_stream, STRATEGY_STREAM_POSITION> {
public:
    ...
    public:
        ...
        virtual int32_t     get_frozen_long_position() const     = 0;
        virtual int32_t     get_frozen_short_position() const    = 0;
        virtual int32_t     get_td_long_position() const         = 0;
        virtual int32_t     get_td_short_position() const        = 0;
        virtual int32_t     get_frozen_td_long_position() const  = 0;
        virtual int32_t     get_frozen_td_short_position() const = 0;
        virtual int32_t     get_yd_long_position() const         = 0;
        virtual int32_t     get_yd_short_position() const        = 0;
        virtual int32_t     get_frozen_yd_long_position() const  = 0;
        virtual int32_t     get_frozen_yd_short_position() const = 0;
        virtual int32_t     get_long_comb_position() const       = 0;
        virtual int32_t     get_short_comb_position() const      = 0;
        virtual int32_t     get_buy_open_position() const        = 0;
...
public:
    position_stream(msg_callback callback, snap_callback s_callback);
    position_stream(msg_callback callback);
    position_stream();
    ~position_stream();
