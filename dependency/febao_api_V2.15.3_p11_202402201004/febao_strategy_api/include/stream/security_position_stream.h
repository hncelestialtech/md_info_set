#ifndef FB_SECURITY_POSITION_STREAM_H
#define FB_SECURITY_POSITION_STREAM_H
...
class security_position_stream :
    public i_stream_with_id<security_position_stream, STRATEGY_STREAM_SECURITY_POSITION> {
public:
...
public:
    security_position_stream(msg_callback callback, snap_callback s_callback);
    security_position_stream(msg_callback callback);
