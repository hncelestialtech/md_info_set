#ifndef FB_INSTRUMENT_PRICING_PARAM_CONFIG_STREAM_H
#define FB_INSTRUMENT_PRICING_PARAM_CONFIG_STREAM_H
...
class instrument_pricing_param_config_stream :
    public i_stream_with_id<instrument_pricing_param_config_stream,
...
public:
    ...
    public:
        ...
        virtual double       get_base_multi() const          = 0;
        virtual double       get_basis() const               = 0;
        virtual double       get_base_offset() const         = 0;
...
public:
    instrument_pricing_param_config_stream(msg_callback  callback,
                                           snap_callback s_callback);
    instrument_pricing_param_config_stream(msg_callback callback);
    instrument_pricing_param_config_stream();
    ~instrument_pricing_param_config_stream();
