#ifndef FB_FUND_INSTRUMENT_INFO_STREAM_H
#define FB_FUND_INSTRUMENT_INFO_STREAM_H
...
class fund_instrument_info_stream :
    public i_stream_with_id<fund_instrument_info_stream,
...
public:
    ...
    public:
        ...
        virtual const int8_t get_fund_class() const               = 0;
...
public:
    fund_instrument_info_stream(msg_callback  callback,
                                snap_callback s_callback);
    fund_instrument_info_stream(msg_callback callback);
    fund_instrument_info_stream();
    ~fund_instrument_info_stream();
