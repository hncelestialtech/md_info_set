...
#ifndef FB_INSTRUMENT_GROUP_CONFIG_STREAM_H
#define FB_INSTRUMENT_GROUP_CONFIG_STREAM_H
...
class instrument_group_config_stream :
    public i_stream_with_id<instrument_group_config_stream,
...
public:
    ...
    public:
        ...
        virtual const char *get_child_instrument_group_id() const = 0;
    ...
    public:
        ...
        virtual bool get_elements(IN const char *instrument_group_id,
                                  OUT std::vector<std::string> &instrument_ids,
                                  OUT  std::vector<std::string>
                                      &child_instrument_group_ids) const = 0;
        virtual const i_stream_msg *get_msg(
            IN const char *instrument_group_id,
            IN const char *child_instrument_group_id) const = 0;
...
public:
    instrument_group_config_stream(msg_callback  callback,
                                   snap_callback s_callback);
    instrument_group_config_stream(msg_callback callback);
    instrument_group_config_stream();
    ~instrument_group_config_stream();
