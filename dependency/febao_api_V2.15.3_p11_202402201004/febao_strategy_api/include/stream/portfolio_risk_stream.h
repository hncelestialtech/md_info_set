#ifndef FB_PORTFOLIO_RISK_STREAM_H
#define FB_PORTFOLIO_RISK_STREAM_H
...
class portfolio_risk_stream :
    public i_stream_with_id<portfolio_risk_stream,
...
public:
    ...
    public:
        ...
        virtual const i_stream_msg *get_msg(IN int portfolio_id) const    = 0;
...
public:
    portfolio_risk_stream(msg_callback callback, snap_callback s_callback);
    portfolio_risk_stream(msg_callback callback);
