#ifndef FB_PORTFOLIO_POSITION_PROFIT_STREAM_H
#define FB_PORTFOLIO_POSITION_PROFIT_STREAM_H
...
class portfolio_position_profit_stream :
    public i_stream_with_id<portfolio_position_profit_stream,
...
public:
    ...
    public:
        ...
        virtual double      get_market_profit() const        = 0;
        virtual double      get_td_market_profit() const     = 0;
        virtual double      get_yd_market_profit() const     = 0;
        virtual double      get_theo_profit() const          = 0;
        virtual double      get_td_theo_profit() const       = 0;
        virtual double      get_yd_theo_profit() const       = 0;
        virtual double      get_market_day_profit() const    = 0;
        virtual double      get_yd_market_day_profit() const = 0;
        virtual double      get_theo_day_profit() const      = 0;
        virtual double      get_yd_theo_day_profit() const   = 0;
...
public:
    portfolio_position_profit_stream(msg_callback  callback,
                                     snap_callback s_callback);
    portfolio_position_profit_stream(msg_callback callback);
    portfolio_position_profit_stream();
    ~portfolio_position_profit_stream();
