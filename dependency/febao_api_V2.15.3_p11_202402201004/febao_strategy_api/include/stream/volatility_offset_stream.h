#ifndef FB_VOLATILITY_OFFSET_STREAM_H
#define FB_VOLATILITY_OFFSET_STREAM_H
...
class volatility_offset_stream :
    public i_stream_with_id<volatility_offset_stream,
...
public:
    ...
    public:
        ...
        virtual double      get_volatility_offset() const       = 0;
    ...
    public:
        ...
        virtual const i_stream_msg *get_msg(
            ...
            IN const double  strike_price) const = 0;
        virtual const i_stream_msg *get_msg(
...
public:
    volatility_offset_stream(msg_callback callback, snap_callback s_callback);
    volatility_offset_stream(msg_callback callback);
    volatility_offset_stream();
    ~volatility_offset_stream();
