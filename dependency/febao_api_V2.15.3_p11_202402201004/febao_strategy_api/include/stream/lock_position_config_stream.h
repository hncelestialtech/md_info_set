#ifndef FB_LOCK_POSITION_CONFIG_STREAM_H
#define FB_LOCK_POSITION_CONFIG_STREAM_H
...
class lock_position_config_stream :
    public i_stream_with_id<lock_position_config_stream,
...
public:
    ...
    public:
        ...
        virtual int32_t     get_lock_long_position() const  = 0;
        virtual int32_t     get_lock_short_position() const = 0;
...
public:
    lock_position_config_stream(msg_callback  callback,
                                snap_callback s_callback);
    lock_position_config_stream(msg_callback callback);
    lock_position_config_stream();
    ~lock_position_config_stream();
