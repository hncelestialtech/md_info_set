#ifndef FB_INSTURMENT_TRADING_STATUS_STREAM_H
#define FB_INSTURMENT_TRADING_STATUS_STREAM_H
...
class instrument_trading_status_stream :
    public i_stream_with_id<instrument_trading_status_stream,
...
public:
    ...
    public:
        ...
        virtual const int8_t get_instrument_trading_status() const = 0;
...
public:
    instrument_trading_status_stream(msg_callback  callback,
                                     snap_callback s_callback);
    instrument_trading_status_stream(msg_callback callback);
    instrument_trading_status_stream();
    ~instrument_trading_status_stream();
