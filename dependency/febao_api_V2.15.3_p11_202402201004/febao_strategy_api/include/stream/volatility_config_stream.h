#ifndef FB_VOLATILITY_CONFIG_STREAM_H
#define FB_VOLATILITY_CONFIG_STREAM_H
...
class volatility_config_stream :
    public i_stream_with_id<volatility_config_stream,
...
public:
    ...
    public:
        ...
        virtual int8_t      get_double_curve_fit() const        = 0;
...
public:
    volatility_config_stream(msg_callback callback, snap_callback s_callback);
    volatility_config_stream(msg_callback callback);
    volatility_config_stream();
    ~volatility_config_stream();
