...
void get_strategy_param_info(char param_info[64][256], int *count) {
    ...
    strcpy(param_info[2], "product/string/IO/0");
    strcpy(param_info[3], "trading_section/string/CFFEX/0");
    strcpy(param_info[4], "waiting_second/double/15/1");
    strcpy(param_info[5], "duration_second/double/10/1");
    strcpy(param_info[6], "netpos_limit/int/50/1");
    *count = 7;
}
