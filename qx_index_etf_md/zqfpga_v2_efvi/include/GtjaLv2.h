...
struct EfviWrapper
{
    ...
    ef_vi m_vi;
    struct pkt_buf **m_pkt_bufs;
    void *m_pbuff;
    ef_pd m_pd;
    ef_memreg m_memreg;
    unsigned long m_rxBuffLen;
    unsigned long volatile m_postIndex;
    unsigned long volatile m_rcvIndex;
    unsigned long volatile m_dealIndex;
    unsigned long m_vi_recv_prefix;
};
